<x-guest-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">En GM Estilos, cada uno de nuestros servicios está diseñado para ofrecerte la máxima precisión, calidad e innovación, asegurando que tu calzado sea único y de alto rendimiento.</p>
            <div class="grid gap-8 mt-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                @foreach ($categories as $category)
                    <div class="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                        <h3 class="text-2xl font-bold text-blue-900 dark:text-white mb-4">{{ $category->title }}</h3>
                        <p class="mt-2 text-gray-500 dark:text-gray-400 mb-4">{!! $category->description !!}</p>
